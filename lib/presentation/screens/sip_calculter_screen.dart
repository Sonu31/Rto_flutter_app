...
class SipCalculatorLayout extends StatefulWidget {
  const SipCalculatorLayout({super.key});

  @override
  _MobileLayoutState createState() => _MobileLayoutState();
}

class _MobileLayoutState extends State<SipCalculatorLayout> {
        ...
        children: [
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
                padding: const EdgeInsets.all(20.0), backgroundColor: Colors.greenAccent,
                textStyle:
